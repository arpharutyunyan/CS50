"""
    ...
    consumed raw fruits … in the United States. Retail stores are welcome to download the posters, print, display and/or distribute them to consumers 
    ...
    the number of calories in one portion of that fruit, per the FDA’s poster for fruits, which is also available as text. Capitalization aside, 
...
if fruit in nutrition.keys():
    output = nutrition[fruit]
    print(f"Calories: {output}")